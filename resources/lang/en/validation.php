...
return [
    ...
    */
    ...
    'accepted' => 'يجب قبول منطقة :attribute',
    'employee' => 'موظف',
    ...
    'array' => 'يجب أن يكون منطقة :attribute ًمصفوفة',
    ...
    'doesnt_end_with' => 'منطقة :attribute يجب ألا ينتهي بواحدة من القيم التالية: :values.',
    'doesnt_start_with' => 'منطقة :attribute يجب ألا يبدأ بواحدة من القيم التالية: :values.',
    ...
    'image' => 'يجب أن يكون منطقة :attribute صورةً.',
    'in' => 'حقل المحدد :attribute غير صالح.',
    'in_array' => 'منطقة :attribute غير موجود في :other.',
    'integer' => 'يجب أن يكون منطقة :attribute عددًا صحيحًا',
    ...
    'lowercase' => 'منطقة :attribute يجب ان يكون حروف صغيرة',
    'lt' => [
    ...
    'max' => [
        'array' => 'يجب أن لا يحتوي منطقة :attribute على أكثر من :max عناصر/عنصر.',
    ...
    'max_digits' => 'منطقة :attribute يجب ألا يحتوي أكثر من :max أرقام.',
    'mimes' => 'حقل :attribute يجب ان يكون ملف من نوع: :values.',
    'mimetypes' => 'حقل :attribute يجب ان يكون ملف من نوع: :values.',
    'min' => [
        'array' => 'يجب أن يحتوي منطقة :attribute على الأقل على :min عُنصرًا/عناصر',
        'file' => 'يجب أن يكون حجم الملف :attribute على الأقل :min كيلوبايت',
        'numeric' => 'يجب أن تكون قيمة منطقة :attribute مساوية أو أكبر لـ :min.',
        'string' => 'يجب أن يكون طول نص :attribute على الأقل :min حروفٍ/حرفًا',
    ],
    'min_digits' => 'منطقة :attribute يجب أن يحتوي :min أرقام على الأقل.',
    ...
    'multiple_of' => 'منطقة :attribute يجب أن يكون من مضاعفات :value.',
    'not_in' => 'منطقة المحدد :attribute غير صالح',
    ...
    'present' => 'يجب تقديم منطقة :attribute',
    'prohibited' => 'منطقة :attribute محظور',
    'prohibited_if' => 'منطقة :attribute محظور في حال ما إذا كان :other يساوي :value.',
    'prohibited_unless' => 'منطقة :attribute محظور في حال ما لم يكون :other يساوي :value.',
    'prohibits' => 'منطقة :attribute يحظر :other من اي يكون موجود',
    'regex' => 'صيغة حقل :attribute غير صالحة.',
    'required' => 'منطقة :attribute مطلوب.',
    'required_array_keys' => 'منطقة :attribute يجب ان يحتوي علي مدخلات للقيم التالية :values.',
    'required_if' => 'منطقة :attribute مطلوب في حال ما إذا كان :other يساوي :value.',
    'required_if_accepted' => 'حقل :attribute مطلوب عندما يكون :other مقبول.',
    'required_unless' => 'منطقة :attribute مطلوب في حال ما لم يكن :other يساوي :values.',
    'required_with' => 'منطقة :attribute مطلوب إذا توفّر :values.',
    'required_with_all' => 'منطقة :attribute مطلوب إذا توفّر :values.',
    'required_without' => 'منطقة :attribute مطلوب إذا لم يتوفّر :values.',
    'required_without_all' => 'منطقة :attribute مطلوب إذا لم يتوفّر :values.',
    'same' => 'يجب أن يتطابق منطقة :attribute مع :other',
    'size' => [
        'array' => 'يجب أن يحتوي منطقة :attribute على :size عنصرٍ/عناصر بالظبط',
        'file' => 'يجب أن يكون حجم الملف :attribute :size كيلوبايت',
        'numeric' => 'يجب أن تكون قيمة منطقة :attribute مساوية لـ :size',
    ...
    'unique' => 'قيمة منطقة :attribute مُستخدمة من قبل',
    ...
    */
    ...
    'attributes' => [
        ...
        'title'                 => 'العنوان',
        'q'                     => 'البحث',
        'date_start'            => 'تاريخ وساعة الحجز',
        'number_of_hours'       => 'عدد ساعات الحجز',
        'link'                  => 'رابط',
        'type'                  => 'النوع',
        'employee'                  => 'موظف',
        'job_name'                  => 'اسم الوظيفة',
        'job_number'                  => 'رقم الوظيفة',
        'tshirt_size'                  => 'قياس الملابس',
        // 'slug'                  => ' ',
    ],
